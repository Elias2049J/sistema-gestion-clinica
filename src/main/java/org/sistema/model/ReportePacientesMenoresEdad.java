...
@AllArgsConstructor
@NoArgsConstructor
public class ReportePacientesMenoresEdad implements ReporteUseCase<Paciente> {
    private CrudUseCase<Paciente, Integer, String> crudPacienteModel;
    private PersistenceUseCase<Paciente> persistenciaPacientesMenoresEdad;

    @Override
    public List<String> generarReporte() {
        List<String> report = new ArrayList<>();
        report.add("|====================================LISTA PACIENTES MENORES DE EDAD=====================================|");
    ...
    public boolean imprimirReporte() {
        return persistenciaPacientesMenoresEdad.exportarLista(getListaReporte());
    }
